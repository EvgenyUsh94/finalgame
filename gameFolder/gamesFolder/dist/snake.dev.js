...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var buttons = document.querySelectorAll('.music-buttons button');
  var rockButton = document.getElementById('rock-button');
  var popButton = document.getElementById('pop-button');
  var hiphopButton = document.getElementById('hiphop-button');
  var electroButton = document.getElementById('electro-button');
  var audioSource = document.getElementById('audio-source'); // Set the audio source and play it when a button is clicked
  ...
  buttons.forEach(function (button) {
    button.addEventListener('click', function () {
      var musicType = this.id.replace('-button', ''); // Extract music type from button id

      var musicPath = musicLibrary[musicType];
